...
# Download button for A4 PDF (PRO layout) — call after function definition
if p1 and metrics_sel:
    pdf_buf = make_radar_bars_pdf_a4_pro(
        df_all,
        p1,
    ...
    st.download_button("⬇️ Download Radar (PDF A4)", data=pdf_buf.getvalue(),
                       file_name="radar_A4.pdf", mime="application/pdf")

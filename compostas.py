...
def plot_radar(df: pd.DataFrame, player_a: str, player_b: str | None, metrics: list[str],
    ...
    radar.draw_radar(v_a, ax=ax, kwargs_radar={"facecolor": color_a, "edgecolor": color_a, "linewidth": 2.8, "alpha": 0.18})
    if v_b is not None:
        radar.draw_radar(v_b, ax=ax, kwargs_radar={"facecolor": color_b, "edgecolor": color_b, "linewidth": 2.8, "alpha": 0.18})
